...
public class LabelDemo extends JPanel {
	public LabelDemo() {
		...
		//ImageIcon icon = createImageIcon("image/head/10.jpg","a pretty but meaningless splat");
		ImageIcon icon =new ImageIcon("image/head/10.jpg");
