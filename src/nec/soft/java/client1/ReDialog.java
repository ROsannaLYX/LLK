...
class ReDialog extends JDialog
{
	...
	public void initComment()
	{
		...
		sexBox.setBounds(40,90,50,30);
		add(passwdText);
		add(nameText);
		add(sexBox);
		
		//头像
		headIconLb.setBounds(140,87,60,60);
		...
		//按钮
		okBt.setBounds(250,87,60,30);
		cancel.setBounds(250,120,60,30);
		add(okBt);
		add(cancel);
